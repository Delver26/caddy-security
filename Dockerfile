...
RUN xcaddy build --with github.com/greenpau/caddy-security@v1.1.17 --with github.com/greenpau/caddy-trace --with github.com/crewjam/saml@v0.4.10=github.com/greenpau/origin_crewjam_saml@v0.4.11-0.20221229165346-936eba92623a
FROM caddy:latest
